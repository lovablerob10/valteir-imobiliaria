                        ...
                        <div className="p-8 pt-6 space-y-8">
                            ...
                            <div className="flex items-center gap-4 pt-4 border-t border-zinc-900">
                                <Button
                                    ...
                                    onClick={() => window.open(`https://wa.me/55${(selectedLead.telefone || '').replace(/\D/g, '')}?text=Olá ${selectedLead.nome}, recebemos seu contato na Valteir Imóveis. Como podemos ajudar?`, '_blank')}
                                ...
                                <Button
                                    ...
                                    onClick={() => window.location.href = `mailto:${selectedLead.email || ''}?subject=Retorno - Valteir Imóveis`}
