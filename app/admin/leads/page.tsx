                    ...
                    {selectedLead && (
                        <div className="p-8 pt-6 space-y-8">
                            ...
                            <div className="flex items-center gap-4 pt-4 border-t border-zinc-900">
                                <Button className="flex-1 bg-accent hover:bg-white text-primary font-bold h-12 rounded-xl transition-all">
                                    <Phone className="w-4 h-4 mr-2" /> Iniciar WhatsApp
                                </Button>
                                <Button variant="outline" className="flex-1 border-zinc-800 hover:bg-zinc-900 text-white h-12 rounded-xl">
