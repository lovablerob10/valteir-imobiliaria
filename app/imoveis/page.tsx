...
export default function PropertiesPage() {
    ...
    }, [search, type, priceRange, supabase]);
        ...
        <main className="min-h-screen bg-primary pt-32 pb-24 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    {/* Filtros */}
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 bg-zinc-900/50 p-6 rounded-2xl border border-zinc-800/50 backdrop-blur-sm">
