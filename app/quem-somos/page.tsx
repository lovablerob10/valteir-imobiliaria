        ...
        <main ref={mainRef} className="bg-zinc-950 text-white overflow-x-hidden">
            ...
            <section className="hero-section relative h-screen flex items-center px-4 md:px-8 overflow-hidden pt-20">
                <div className="hero-bg absolute inset-0 z-0">
                    <Image
                        src="https://images.unsplash.com/photo-1600607687940-4e5272a95d29?auto=format&fit=crop&q=80&w=2000"
                        alt="Background Luxo"
                        fill
            ...
            <section className="story-section relative min-h-screen bg-zinc-950 flex items-center py-20 pb-40">
                <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center w-full">
                    <div className="relative aspect-[3/4] rounded-sm overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.5)] border border-white/5">
                        <Image
                    ...
                    <div className="space-y-48 lg:pl-12">
